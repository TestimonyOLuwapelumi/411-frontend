  ...
  return (
    <div className={cx( classes, {'invisible': ! visible && hasVisibilityToggle} )}>
      <div className="inline-flex rounded-md shadow-sm ml-8">
        <div
          className={cx(contentColorClass, 'inline-flex items-center px-4 py-2 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-blue-800 hover:bg-rose-500 focus:border-blue-800 active:bg-blue-800 transition ease-in-out duration-150 cursor-not-allowed')}
        >
          { showSpinner ? (
