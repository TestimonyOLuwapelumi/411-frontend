...
const Footer = () => {
  return (
    ...
    <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
      <div className="lg:w-1/3">
        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
          ...
          <span className="self-center text-2xl font-semibold">THX 411</span>
        </a>
      </div>
      <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
        <div className="space-y-3">
          ...
          <ul className="space-y-1">
            ...
            <li>
              <a rel="noopener noreferrer" href="#">ADVERTISE WITH US</a>
            </li>
            <li>
              <a rel="noopener noreferrer" href="#">MAKE A DONATION</a>
            </li>
            <li>
        ...
        <div className="space-y-3">
          <h3 className="tracking-wide uppercase dark:text-gray-50">LEGA</h3>
          <ul className="space-y-1">
            <li>
              <a rel="noopener noreferrer" href="#">PRIVACY & CONDITION</a>
            </li>
            <li>
        ...
        <div className="space-y-3">
          ...
          <Link to={`https://www.tiktok.com/@_thx411`}>
    ...
    <div className="py-6 text-sm text-center dark:text-gray-400">© 2023 THX 411. All rights reserved.</div>
  </footer>
